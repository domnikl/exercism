defmodule KitchenCalculator do
  ...
  def convert({from, volume}, to) when from == to, do: {to, volume}
  def convert({:milliliter, volume}, to), do: from_milliliter({:milliliter, volume}, to)
  def convert({from, volume}, to) do
    {_, milliliter} = to_milliliter({from, volume})

    from_milliliter({:milliliter, milliliter}, to)
  end
end
